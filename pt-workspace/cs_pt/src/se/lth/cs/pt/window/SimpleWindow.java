...
public class SimpleWindow {
    ...
    private volatile int penX, penY;     // volatile för att publicera förändringar till EDT
    ...
    private void makeUpdatesVisibleToEdt() {
        penX = penX;   // volatile -> publicera förändringar
    }
...
//				}
    ...
    private class SimpleWindowFrame extends JFrame {
        ...
        // uppdateringsfrekvens (60Hz)
        private static final int REPAINT_PERIOD = 16;

        private final Timer repaintTimer = new Timer(REPAINT_PERIOD, e -> repaint());
        ...
        private final JPanel panel          = new JPanel() {
            ...
            public void paintComponent(Graphics g) {
                ...
                g.drawImage(pixels, 0, 0, getWidth(), getHeight(), this);
            }
        };
        ...
        private class SimpleWindowControls extends WindowControls {
            ...
            public void setAutoUpdate(boolean on) {
                SwingUtilities.invokeLater(() -> {if (on) repaintTimer.start(); else repaintTimer.stop();});
            }
