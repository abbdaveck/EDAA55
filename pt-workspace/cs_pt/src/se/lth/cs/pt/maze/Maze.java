...
public class Maze {
     ...
     * mazeN.maze (N: 1..6), which must be in cs_pt.jar, which must be on the class
     * path.
     *
     * @param nbr the number of the maze
     */
    public Maze(int nbr) {
        try {
     ...
     * @param xEntry   x coordinate of the maze's entry point
     * @param yEntry   y coordinate of the maze's entry point
     */
     ...
     *
     * @param w the SimpleWindow to draw in
     */
    public void draw(SimpleWindow w) {
        w.moveTo(BORDER_WIDTH, BORDER_WIDTH);
        w.getAdvancedControls().drawImage(image);
    }
     ...
     *
     * @param direction the direction (0, 90, 180, 270 degrees)
     * @param x         the x coordinate
     * @param y         the y coordinate
